<template>
  <div>
    ...
    <div class="text-center">
      <h1 class="text-6xl mt-20 text-extrabold">Article for everyone</h1>
      <p class="item-center text-semiblod text-xl">Nous vous proposons les meilleurs articles dans des domaines divers
        & en vogue
      </p>
    </div>
  </div>
